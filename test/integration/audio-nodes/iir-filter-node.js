...
describe('IIRFilterNode', { skip: typeof window === 'undefined' }, () => {
    describe.for(Object.entries(testCases))('with the %s', ([description, { createContext, createIIRFilterNode }]) => {
        let context;
        let feedback;
        let feedforward;
                ...
                describe('with invalid options', () => {
                    describe('without any feedback coefficients', () => {
                        it('should throw a NotSupportedError', () => {
                            expect(() => createIIRFilterNode(context, { feedback: [], feedforward }))
                    ...
                    describe('with feedback coefficients beginning with zero', () => {
                        it('should throw an InvalidStateError', () => {
                            expect(() => createIIRFilterNode(context, { feedback: [0, 1], feedforward }))
                                .to.throw(DOMException)
                    ...
                    describe('with feedforward coefficients of only zero', () => {
                        it('should throw an InvalidStateError', () => {
                            expect(() => createIIRFilterNode(context, { feedback, feedforward: [0] }))
                                .to.throw(DOMException)
                                .to.include({ code: 11, name: 'InvalidStateError' });
                        });
                    });
        ...
        describe('connect()', () => {
            describe.for(['AudioNode', 'AudioParam'])('with an %s', (type) => {
                ...
                it('should throw an IndexSizeError if the output is out-of-bound', () => {
                    expect(() => iIRFilterNode.connect(audioNodeOrAudioParam, -1))
                        .to.throw(DOMException)
                ...
                if (type === 'AudioNode') {
                    it('should throw an IndexSizeError if the input is out-of-bound', () => {
                        expect(() => iIRFilterNode.connect(audioNodeOrAudioParam, 0, -1))
                            .to.throw(DOMException)
                            .to.include({ code: 1, name: 'IndexSizeError' });
                    });
            ...
            describe.for(['AudioNode', 'AudioParam'])('with an %s of another context', (type) => {
                ...
                it('should throw an InvalidAccessError', () => {
                    expect(() => iIRFilterNode.connect(audioNodeOrAudioParam))
                        .to.throw(DOMException)
            ...
            describe.for(['AudioNode', 'AudioParam'])('with an %s of a native context', (type) => {
                ...
                it('should throw an InvalidAccessError', () => {
                    expect(() => iIRFilterNode.connect(nativeAudioNodeOrAudioParam))
                        .to.throw(DOMException)
                        .to.include({ code: 15, name: 'InvalidAccessError' });
                });
            });
        ...
        describe('disconnect()', () => {
            ...
            describe('with an output', () => {
                describe('with a value which is out-of-bound', () => {
                    ...
                    it('should throw an IndexSizeError', () => {
                        expect(() => iIRFilterNode.disconnect(-1))
                            .to.throw(DOMException)
                            .to.include({ code: 1, name: 'IndexSizeError' });
                    });
                });
            ...
            describe('with a destination', () => {
                describe('without a connection to the given destination', () => {
                    ...
                    it('should throw an InvalidAccessError', () => {
                        expect(() => iIRFilterNode.disconnect(new GainNode(context)))
                            .to.throw(DOMException)
                            .to.include({ code: 15, name: 'InvalidAccessError' });
                    });
                });
            ...
            describe('with a destination and an output', () => {
                ...
                it('should throw an IndexSizeError if the output is out-of-bound', () => {
                    expect(() => iIRFilterNode.disconnect(new GainNode(context), -1))
                        .to.throw(DOMException)
                        .to.include({ code: 1, name: 'IndexSizeError' });
                });

                it('should throw an InvalidAccessError if there is no similar connection', () => {
                    expect(() => iIRFilterNode.disconnect(new GainNode(context), 0))
                        .to.throw(DOMException)
                        .to.include({ code: 15, name: 'InvalidAccessError' });
                });
            });
            ...
            describe('with a destination, an output and an input', () => {
                ...
                it('should throw an IndexSizeError if the output is out-of-bound', () => {
                    expect(() => iIRFilterNode.disconnect(new GainNode(context), -1, 0))
                        .to.throw(DOMException)
                        .to.include({ code: 1, name: 'IndexSizeError' });
                });

                it('should throw an IndexSizeError if the input is out-of-bound', () => {
                    expect(() => iIRFilterNode.disconnect(new GainNode(context), 0, -1))
                        .to.throw(DOMException)
                        .to.include({ code: 1, name: 'IndexSizeError' });
                });

                it('should throw an InvalidAccessError if there is no similar connection', () => {
                    expect(() => iIRFilterNode.disconnect(new GainNode(context), 0, 0))
                        .to.throw(DOMException)
                        .to.include({ code: 15, name: 'InvalidAccessError' });
                });
            });
        ...
        describe('getFrequencyResponse()', () => {
            describe('with a frequencyHz parameter smaller as the others', () => {
                it('should throw an InvalidAccessError', () => {
                    ...
                    expect(() => iIRFilterNode.getFrequencyResponse(new Float32Array(), new Float32Array(1), new Float32Array(1)))
                        .to.throw(DOMException)
                        .to.include({ code: 15, name: 'InvalidAccessError' });
                });
            });
            ...
            describe('with a magResponse parameter smaller as the others', () => {
                it('should throw an InvalidAccessError', () => {
                    ...
                    expect(() => iIRFilterNode.getFrequencyResponse(new Float32Array([1]), new Float32Array(0), new Float32Array(1)))
                        .to.throw(DOMException)
                        .to.include({ code: 15, name: 'InvalidAccessError' });
                });
            });
            ...
            describe('with a phaseResponse parameter smaller as the others', () => {
                it('should throw an InvalidAccessError', () => {
                    ...
                    expect(() => iIRFilterNode.getFrequencyResponse(new Float32Array([1]), new Float32Array(1), new Float32Array(0)))
                        .to.throw(DOMException)
                        .to.include({ code: 15, name: 'InvalidAccessError' });
                });
            });
