...
The list of currently supported browsers includes Chrome v99+, Firefox v70+ and Safari v15.6+. Please note that the tests only run in the current and upcoming version of each browser.
