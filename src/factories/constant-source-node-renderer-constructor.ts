...
import { TConstantSourceNodeRendererConstructorFactory, TUnpatchedOfflineAudioContext } from '../types';

export const createConstantSourceNodeRendererConstructor: TConstantSourceNodeRendererConstructorFactory = (
    createNativeConstantSourceNode
) => {

    return class ConstantSourceNodeRenderer extends AudioNodeRenderer {
