...
describe('splitImportStatements()', () => {
    ...
    describe('with a source that contains a default import statement', () => {
        ...
        it('should split the import statement', () => {
            ...
            expect(splitImportStatements(source, url)).to.deep.equal([ "import all from 'https://example.com/something'", 'const value = 0;' ]);
        });
    ...
    describe('with a source that contains a named import statement', () => {
        ...
        it('should split the import statement', () => {
            ...
            expect(splitImportStatements(source, url)).to.deep.equal([ "import { one } from 'https://example.com/something'", 'const value = 0;' ]);
        });
    ...
    describe('with a source that contains multiple named import statement', () => {
        ...
        it('should split the import statement', () => {
            ...
            expect(splitImportStatements(source, url)).to.deep.equal([ "import { one, two, three } from 'https://example.com/something'", 'const value = 0;' ]);
        });
    ...
    describe('with a source that contains a renamed import statement', () => {
        ...
        it('should split the import statement', () => {
            ...
            expect(splitImportStatements(source, url)).to.deep.equal([ "import { one as two } from 'https://example.com/something'", 'const value = 0;' ]);
        });
    ...
    describe('with a source that contains multiple renamed import statement', () => {
        ...
        it('should split the import statement', () => {
            ...
            expect(splitImportStatements(source, url)).to.deep.equal([ "import { one as two, two as three } from 'https://example.com/something'", 'const value = 0;' ]);
        });
    ...
    describe('with a source that contains a namespace import statement', () => {
        ...
        it('should split the import statement', () => {
            ...
            expect(splitImportStatements(source, url)).to.deep.equal([ "import * as mdl from 'https://example.com/something'", 'const value = 0;' ]);
        });
    ...
    describe('with a source that contains a default and a namespace import statement', () => {
        ...
        it('should split the import statement', () => {
            ...
            expect(splitImportStatements(source, url)).to.deep.equal([ "import all, * as mdl from 'https://example.com/something'", 'const value = 0;' ]);
        });
    ...
    describe('with a source that contains a default and a named import statement', () => {
        ...
        it('should split the import statement', () => {
            ...
            expect(splitImportStatements(source, url)).to.deep.equal([ "import all, { one } from 'https://example.com/something'", 'const value = 0;' ]);
        });
