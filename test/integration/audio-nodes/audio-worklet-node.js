...
describe('AudioWorkletNode', { skip: typeof window === 'undefined' }, () => {
    describe.for(Object.entries(testCases))('with the %s', ([description, { createAddAudioWorkletModule, createContext }]) => {
        ...
        describe('constructor()', () => {
            describe.for(['closed', 'running'])('with an audioContextState of "%s"', (audioContextState) => {
                ...
                describe('with valid options', () => {
                    ...
                    it('should return an instance with the given channelCountMode', async () => {
                        await addAudioWorkletModule('test/fixtures/gain-processor.js');

                        const channelCountMode = 'explicit';
                        const audioWorkletNode = createAudioWorkletNode(context, 'gain-processor', { channelCountMode });

                        expect(audioWorkletNode.channelCountMode).to.equal(channelCountMode);
                    });
                    ...
                    it('should pass on the parameterData to the AudioWorkletProcessor', () => {
                        const { promise, resolve } = Promise.withResolvers();

                        addAudioWorkletModule('test/fixtures/inspector-processor.js').then(() => {
                    ...
                    it('should return an instance with a parameter initialized to the given value', async () => {
                    ...
                    it('should pass on the processorOptions to the AudioWorkletProcessor', () => {
                        const { promise, resolve } = Promise.withResolvers();
                    ...
                    it('should pass on the default processorOptions to the AudioWorkletProcessor', () => {
                        const { promise, resolve } = Promise.withResolvers();
                ...
                describe('with invalid options', () => {
                    ...
                    describe('with numberOfInputs and numberOfOutputs both set to zero', () => {
                        it('should throw a NotSupportedError', () => {
                            expect(() =>
                                createAudioWorkletNode(context, 'inspector-processor', {
                                    numberOfInputs: 0,
                                    numberOfOutputs: 0
                                })
                            )
                    ...
                    describe('without enough outputs specified in outputChannelCount', () => {
                        it('should throw an IndexSizeError', () => {
                            expect(() => createAudioWorkletNode(context, 'inspector-processor', { outputChannelCount: [] }))
                                .to.throw(DOMException)
                    ...
                    describe('with too many outputs specified in outputChannelCount', () => {
                        it('should throw an IndexSizeError', () => {
                            expect(() => createAudioWorkletNode(context, 'inspector-processor', { outputChannelCount: [4, 2] }))
                                .to.throw(DOMException)
                                .to.include({ code: 1, name: 'IndexSizeError' });
                        });
                    });
                    ...
                    describe('with an invalid value for one of the outputs specified in outputChannelCount', () => {
                        it('should throw a NotSupportedError', () => {
                            expect(() => createAudioWorkletNode(context, 'inspector-processor', { outputChannelCount: [0] }))
                                .to.throw(DOMException)
                                .to.include({ code: 9, name: 'NotSupportedError' });
                        });
                    });
                    ...
                    describe('with the name of an unknown processor', () => {
                        it('should throw a NotSupportedError', () => {
                            expect(() => createAudioWorkletNode(context, 'unknown-processor'))
                                .to.throw(DOMException)
                                .to.include({ code: 9, name: 'NotSupportedError' });
                        });
                    });
        ...
        describe('onprocessorerror', () => {
            ...
            it('should register an independent event listener', async () => {
                await addAudioWorkletModule('test/fixtures/gain-processor.js');
            ...
            describe('with a processor without a process function', () => {
                ...
                beforeEach(async () => {
                    await addAudioWorkletModule('test/fixtures/processless-processor.js');

                    audioWorkletNode = createAudioWorkletNode(context, 'processless-processor');
                });

                it('should fire an assigned processorerror event listener', () => {
                    const { promise, resolve } = Promise.withResolvers();
            ...
            describe('with a failing processor', () => {
                ...
                beforeEach(async () => {
                    await addAudioWorkletModule('test/fixtures/failing-processor.js');
        ...
        describe('parameters', () => {
            it('should return an implementation of the AudioParamMap interface', async () => {
                await addAudioWorkletModule('test/fixtures/gain-processor.js');
        ...
        describe('port', () => {
            ...
            it('should echo any message when using addEventListener', () => {
                const { promise, resolve } = Promise.withResolvers();
            ...
            it('should echo any message when using onmessage', () => {
                const { promise, resolve } = Promise.withResolvers();
                const message = { a: 'simple', test: 'message' };
        ...
        describe('addEventListener()', () => {
            it('should fire a registered processorerror event listener', () => {
                const { promise, resolve } = Promise.withResolvers();

                addAudioWorkletModule('test/fixtures/failing-processor.js').then(() => {
        ...
        describe('connect()', () => {
            ...
            describe.for(['AudioNode', 'AudioParam'])('with an %s', (type) => {
                ...
                it('should throw an IndexSizeError if the output is out-of-bound', () => {
                    expect(() => audioWorkletNode.connect(audioNodeOrAudioParam, -1))
                        .to.throw(DOMException)
                        .to.include({ code: 1, name: 'IndexSizeError' });
                });
                ...
                if (type === 'AudioNode') {
                    it('should throw an IndexSizeError if the input is out-of-bound', () => {
                        expect(() => audioWorkletNode.connect(audioNodeOrAudioParam, 0, -1))
                            .to.throw(DOMException)
                            .to.include({ code: 1, name: 'IndexSizeError' });
                    });
            ...
            describe.for(['AudioNode', 'AudioParam'])('with an %s of another context', (type) => {
                ...
                it('should throw an InvalidAccessError', () => {
                    expect(() => audioWorkletNode.connect(audioNodeOrAudioParam))
                        .to.throw(DOMException)
            ...
            describe.for(['AudioNode', 'AudioParam'])('with an %s of a native context', (type) => {
                ...
                it('should throw an InvalidAccessError', () => {
                    expect(() => audioWorkletNode.connect(nativeAudioNodeOrAudioParam))
                        .to.throw(DOMException)
                        .to.include({ code: 15, name: 'InvalidAccessError' });
                });
            });
        ...
        describe('disconnect()', () => {
            ...
            describe('with an output', () => {
                describe('with a value which is out-of-bound', () => {
                    ...
                    it('should throw an IndexSizeError', () => {
                        expect(() => audioWorkletNode.disconnect(-1))
                            .to.throw(DOMException)
                            .to.include({ code: 1, name: 'IndexSizeError' });
                    });
                });
            ...
            describe('with a destination', () => {
                describe('without a connection to the given destination', () => {
                    ...
                    it('should throw an InvalidAccessError', () => {
                        expect(() => audioWorkletNode.disconnect(new GainNode(context)))
                            .to.throw(DOMException)
                            .to.include({ code: 15, name: 'InvalidAccessError' });
                    });
                });
            ...
            describe('with a destination and an output', () => {
                ...
                it('should throw an IndexSizeError if the output is out-of-bound', () => {
                    expect(() => audioWorkletNode.disconnect(new GainNode(context), -1))
                        .to.throw(DOMException)
                        .to.include({ code: 1, name: 'IndexSizeError' });
                });

                it('should throw an InvalidAccessError if there is no similar connection', () => {
                    expect(() => audioWorkletNode.disconnect(new GainNode(context), 0))
                        .to.throw(DOMException)
                        .to.include({ code: 15, name: 'InvalidAccessError' });
                });
            });
            ...
            describe('with a destination, an output and an input', () => {
                ...
                it('should throw an IndexSizeError if the output is out-of-bound', () => {
                    expect(() => audioWorkletNode.disconnect(new GainNode(context), -1, 0))
                        .to.throw(DOMException)
                        .to.include({ code: 1, name: 'IndexSizeError' });
                });

                it('should throw an IndexSizeError if the input is out-of-bound', () => {
                    expect(() => audioWorkletNode.disconnect(new GainNode(context), 0, -1))
                        .to.throw(DOMException)
                        .to.include({ code: 1, name: 'IndexSizeError' });
                });

                it('should throw an InvalidAccessError if there is no similar connection', () => {
                    expect(() => audioWorkletNode.disconnect(new GainNode(context), 0, 0))
                        .to.throw(DOMException)
                        .to.include({ code: 15, name: 'InvalidAccessError' });
                });
            });
