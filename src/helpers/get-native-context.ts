...
import { TGetNativeContextFunction, TNativeAudioContext, TNativeOfflineAudioContext } from '../types';

export const getNativeContext: TGetNativeContextFunction = <T extends IMinimalBaseAudioContext>(
    context: T
