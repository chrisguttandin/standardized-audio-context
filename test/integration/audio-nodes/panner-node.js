...
describe('PannerNode', { skip: typeof window === 'undefined' }, () => {
    describe.for(Object.entries(testCases))('with the %s', ([description, { createContext, createPannerNode }]) => {
        let context;
                ...
                describe('with invalid options', () => {
                    describe('with a channelCount greater than 2', () => {
                        it('should throw a NotSupportedError', () => {
                            expect(() => createPannerNode(context, { channelCount: 4 }))
                    ...
                    describe("with a channelCountMode of 'max'", () => {
                        it('should throw a NotSupportedError', () => {
                            expect(() => createPannerNode(context, { channelCountMode: 'max' }))
                                .to.throw(DOMException)
                                .to.include({ code: 9, name: 'NotSupportedError' });
                        });
                    });
                    ...
                    describe('with a coneOuterGain outside of the range from 0 to 1', () => {
                        it('should throw a InvalidStateError', () => {
                            expect(() => createPannerNode(context, { coneOuterGain: -1 }))
                                .to.throw(DOMException)
        ...
        describe('coneOuterGain', () => {
            ...
            it('should not be assignable to a value outside of the range from 0 to 1', () => {
                expect(() => {
            ...
            describe('automation', () => {
                for (const [withADirectConnection, withAnAppendedAudioWorklet] of description.includes('Offline')
                    ...
                    describe(`${withADirectConnection ? 'with' : 'without'} a direct connection and ${
                        ...
                        describe('with a call to cancelScheduledValues()', ({ skip }) => {
                            // @todo
                            skip();
                        });

                        describe('with a call to setValueAtTime()', ({ skip }) => {
                            // @todo
                            skip();
                        });

                        describe('with a call to setValueCurveAtTime()', ({ skip }) => {
                            // @todo
                            skip();
                        });

                        describe('with another AudioNode connected to the AudioParam', ({ skip }) => {
                            // @todo
                            skip();
                        });
        ...
        describe('connect()', () => {
            describe.for(['AudioNode', 'AudioParam'])('with an %s', (type) => {
                ...
                it('should throw an IndexSizeError if the output is out-of-bound', () => {
                    expect(() => pannerNode.connect(audioNodeOrAudioParam, -1))
                        .to.throw(DOMException)
                ...
                if (type === 'AudioNode') {
                    it('should throw an IndexSizeError if the input is out-of-bound', () => {
                        expect(() => pannerNode.connect(audioNodeOrAudioParam, 0, -1))
                            .to.throw(DOMException)
                            .to.include({ code: 1, name: 'IndexSizeError' });
                    });
            ...
            describe.for(['AudioNode', 'AudioParam'])('with an %s of another context', (type) => {
                ...
                it('should throw an InvalidAccessError', () => {
                    expect(() => pannerNode.connect(audioNodeOrAudioParam))
                        .to.throw(DOMException)
            ...
            describe.for(['AudioNode', 'AudioParam'])('with an %s of a native context', (type) => {
                ...
                it('should throw an InvalidAccessError', () => {
                    expect(() => pannerNode.connect(nativeAudioNodeOrAudioParam))
                        .to.throw(DOMException)
                        .to.include({ code: 15, name: 'InvalidAccessError' });
                });
            });
        ...
        describe('disconnect()', () => {
            ...
            describe('with an output', () => {
                describe('with a value which is out-of-bound', () => {
                    ...
                    it('should throw an IndexSizeError', () => {
                        expect(() => pannerNode.disconnect(-1))
                            .to.throw(DOMException)
                            .to.include({ code: 1, name: 'IndexSizeError' });
                    });
                });
            ...
            describe('with a destination', () => {
                describe('without a connection to the given destination', () => {
                    ...
                    it('should throw an InvalidAccessError', () => {
                        expect(() => pannerNode.disconnect(new GainNode(context)))
                            .to.throw(DOMException)
                            .to.include({ code: 15, name: 'InvalidAccessError' });
                    });
                });
            ...
            describe('with a destination and an output', () => {
                ...
                it('should throw an IndexSizeError if the output is out-of-bound', () => {
                    expect(() => pannerNode.disconnect(new GainNode(context), -1))
                        .to.throw(DOMException)
                        .to.include({ code: 1, name: 'IndexSizeError' });
                });

                it('should throw an InvalidAccessError if there is no similar connection', () => {
                    expect(() => pannerNode.disconnect(new GainNode(context), 0))
                        .to.throw(DOMException)
                        .to.include({ code: 15, name: 'InvalidAccessError' });
                });
            });
            ...
            describe('with a destination, an output and an input', () => {
                ...
                it('should throw an IndexSizeError if the output is out-of-bound', () => {
                    expect(() => pannerNode.disconnect(new GainNode(context), -1, 0))
                        .to.throw(DOMException)
                        .to.include({ code: 1, name: 'IndexSizeError' });
                });

                it('should throw an IndexSizeError if the input is out-of-bound', () => {
                    expect(() => pannerNode.disconnect(new GainNode(context), 0, -1))
                        .to.throw(DOMException)
                        .to.include({ code: 1, name: 'IndexSizeError' });
                });

                it('should throw an InvalidAccessError if there is no similar connection', () => {
                    expect(() => pannerNode.disconnect(new GainNode(context), 0, 0))
                        .to.throw(DOMException)
                        .to.include({ code: 15, name: 'InvalidAccessError' });
                });
            });
