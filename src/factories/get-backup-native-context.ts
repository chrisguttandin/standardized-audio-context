...
export const createGetBackupNativeContext: TGetBackupNativeContextFactory = (
    ...
    return <T extends TNativeAudioContext | TNativeOfflineAudioContext>(nativeContext: T): null | T => {
        /*
         * Bug #50: Only Chrome and Safari do currently allow to create AudioNodes on a closed context yet which is why there needs to be
         * no backupNativeContext in that case.
         */
