...
The list of currently supported browsers includes Chrome v105+, Firefox v76+ and Safari v16.4+. Please note that the tests only run in the current and upcoming version of each browser.
