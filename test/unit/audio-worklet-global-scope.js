        ...
        describe(`with the ${description}`, () => {
            ...
            describe('registerProcessor()', () => {
                describe('with an empty string as name', () => {
                    // Bug #134: Chrome, Edge & Opera have the only native implementation so far and don't throw the expected error.
                ...
                describe('with a duplicate name', () => {
                    ...
                    // Bug #135: Chrome, Edge & Opera have the only native implementation so far and don't throw the expected error.
                    if (window.AudioWorkletNode === undefined) {
                        it('should throw an error', function (done) {
                            this.timeout(10000);
                ...
                describe('with a unique name', () => {
                    describe('with a processor without a valid constructor', () => {
                        // Bug #136: Chrome, Edge & Opera have the only native implementation so far and don't throw the expected error.
                        if (window.AudioWorkletNode === undefined) {
                            it('should throw an error', function (done) {
                                this.timeout(10000);
                    ...
                    describe('with a processor without a prototype', () => {
                        // Bug #137: Chrome, Edge & Opera have the only native implementation so far and don't throw the expected error.
                        if (window.AudioWorkletNode === undefined) {
                            it('should throw an error', function (done) {
                                this.timeout(10000);
                    ...
                    describe('with a processor with an invalid parameterDescriptors property', () => {
                        // Bug #139: Chrome, Edge & Opera have the only native implementation so far and don't throw the expected error.
                        if (window.AudioWorkletNode === undefined) {
                            it('should throw an error', function (done) {
                                this.timeout(10000);
