...
describe('AnalyserNode', { skip: typeof window === 'undefined' }, () => {
    describe.for(Object.entries(testCases))('with the %s', ([description, { createAnalyserNode, createContext }]) => {
        let context;
                ...
                describe('with invalid options', () => {
                    describe('with an fftSize below 32', () => {
                        it('should throw an IndexSizeError', () => {
                            expect(() => createAnalyserNode(context, { fftSize: 16 }))
                    ...
                    describe('with an fftSize above 32768', () => {
                        it('should throw an IndexSizeError', () => {
                            expect(() => createAnalyserNode(context, { fftSize: 65536 }))
                                .to.throw(DOMException)
                                .to.include({ code: 1, name: 'IndexSizeError' });
                        });
                    });
                    ...
                    describe('with an fftSize that is not a power of two', () => {
                        it('should throw an IndexSizeError', () => {
                            expect(() => createAnalyserNode(context, { fftSize: 200 }))
                                .to.throw(DOMException)
                                .to.include({ code: 1, name: 'IndexSizeError' });
                        });
                    });
                    ...
                    describe('with a value for maxDecibels that is equal to minDecibels', () => {
                        it('should throw an IndexSizeError', () => {
                            expect(() => createAnalyserNode(context, { maxDecibels: -100 }))
                                .to.throw(DOMException)
                                .to.include({ code: 1, name: 'IndexSizeError' });
                        });
                    });
                    ...
                    describe('with a value for minDecibels that is equal to maxDecibels', () => {
                        it('should throw an IndexSizeError', () => {
                            expect(() => createAnalyserNode(context, { minDecibels: -30 }))
                                .to.throw(DOMException)
                                .to.include({ code: 1, name: 'IndexSizeError' });
                        });
                    });
                    ...
                    describe('with a smoothingTimeConstant below 0', () => {
                        it('should throw an IndexSizeError', () => {
                            expect(() => createAnalyserNode(context, { smoothingTimeConstant: -0.1 }))
                                .to.throw(DOMException)
                                .to.include({ code: 1, name: 'IndexSizeError' });
                        });
                    });
                    ...
                    describe('with a smoothingTimeConstant above 1', () => {
                        it('should throw an IndexSizeError', () => {
                            expect(() => createAnalyserNode(context, { smoothingTimeConstant: 1.1 }))
                                .to.throw(DOMException)
                                .to.include({ code: 1, name: 'IndexSizeError' });
                        });
                    });
        ...
        describe('maxDecibels', ({ skip }) => {
            // @todo
            skip();
        });

        describe('minDecibels', ({ skip }) => {
            // @todo
            skip();
        });
        ...
        describe('smoothingTimeConstant', ({ skip }) => {
            // @todo
            skip();
        });
        ...
        describe('connect()', () => {
            describe.for(['AudioNode', 'AudioParam'])('with an %s', (type) => {
                ...
                it('should throw an IndexSizeError if the output is out-of-bound', () => {
                    expect(() => analyserNode.connect(audioNodeOrAudioParam, -1))
                        .to.throw(DOMException)
                        .to.include({ code: 1, name: 'IndexSizeError' });
                });
                ...
                if (type === 'AudioNode') {
                    it('should throw an IndexSizeError if the input is out-of-bound', () => {
                        expect(() => analyserNode.connect(audioNodeOrAudioParam, 0, -1))
                            .to.throw(DOMException)
                            .to.include({ code: 1, name: 'IndexSizeError' });
                    });
            ...
            describe.for(['AudioNode', 'AudioParam'])('with an %s of another context', (type) => {
                ...
                it('should throw an InvalidAccessError', () => {
                    expect(() => analyserNode.connect(audioNodeOrAudioParam))
                        .to.throw(DOMException)
            ...
            describe.for(['AudioNode', 'AudioParam'])('with an %s of a native context', (type) => {
                ...
                it('should throw an InvalidAccessError', () => {
                    expect(() => analyserNode.connect(nativeAudioNodeOrAudioParam))
                        .to.throw(DOMException)
                        .to.include({ code: 15, name: 'InvalidAccessError' });
                });
            });
        ...
        describe('disconnect()', () => {
            ...
            describe('with an output', () => {
                describe('with a value which is out-of-bound', () => {
                    ...
                    it('should throw an IndexSizeError', () => {
                        expect(() => analyserNode.disconnect(-1))
                            .to.throw(DOMException)
                            .to.include({ code: 1, name: 'IndexSizeError' });
                    });
                });
            ...
            describe('with a destination', () => {
                describe('without a connection to the given destination', () => {
                    ...
                    it('should throw an InvalidAccessError', () => {
                        expect(() => analyserNode.disconnect(new GainNode(context)))
                            .to.throw(DOMException)
                            .to.include({ code: 15, name: 'InvalidAccessError' });
                    });
                });
            ...
            describe('with a destination and an output', () => {
                ...
                it('should throw an IndexSizeError if the output is out-of-bound', () => {
                    expect(() => analyserNode.disconnect(new GainNode(context), -1))
                        .to.throw(DOMException)
                        .to.include({ code: 1, name: 'IndexSizeError' });
                });

                it('should throw an InvalidAccessError if there is no similar connection', () => {
                    expect(() => analyserNode.disconnect(new GainNode(context), 0))
                        .to.throw(DOMException)
                        .to.include({ code: 15, name: 'InvalidAccessError' });
                });
            });
            ...
            describe('with a destination, an output and an input', () => {
                ...
                it('should throw an IndexSizeError if the output is out-of-bound', () => {
                    expect(() => analyserNode.disconnect(new GainNode(context), -1, 0))
                        .to.throw(DOMException)
                        .to.include({ code: 1, name: 'IndexSizeError' });
                });

                it('should throw an IndexSizeError if the input is out-of-bound', () => {
                    expect(() => analyserNode.disconnect(new GainNode(context), 0, -1))
                        .to.throw(DOMException)
                        .to.include({ code: 1, name: 'IndexSizeError' });
                });

                it('should throw an InvalidAccessError if there is no similar connection', () => {
                    expect(() => analyserNode.disconnect(new GainNode(context), 0, 0))
                        .to.throw(DOMException)
                        .to.include({ code: 15, name: 'InvalidAccessError' });
                });
            });
