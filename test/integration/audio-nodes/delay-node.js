...
describe('DelayNode', { skip: typeof window === 'undefined' }, () => {
    describe.for(Object.entries(testCases))('with the %s', ([description, { createContext, createDelayNode }]) => {
        let context;
                ...
                describe('with invalid options', () => {
                    describe('with a maxDelayTime below zero', () => {
                        it('should throw a NotSupportedError', () => {
                            expect(() => createDelayNode(context, { maxDelayTime: -1 }))
                    ...
                    describe('with a maxDelayTime of more than three minutes', () => {
                        it('should throw a NotSupportedError', () => {
                            expect(() => createDelayNode(context, { maxDelayTime: 181 }))
                                .to.throw(DOMException)
                                .to.include({ code: 9, name: 'NotSupportedError' });
                        });
                    });
                ...
                for (const [withADirectConnection, withAnAppendedAudioWorklet] of description.includes('Offline')
                    ...
                    describe(`${withADirectConnection ? 'with' : 'without'} a direct connection and ${
                        ...
                        describe(
                            ...
                            { skip: typeof window === 'undefined' || /Chrome/.test(navigator.userAgent) },
                            () => {
                        ...
                        // Bug #185: Chrome adds an extra sample to the delay.
                        describe(
                            'with a call to setValueCurveAtTime()',
                            { skip: typeof window === 'undefined' || /Chrome/.test(navigator.userAgent) },
                            () => {
                                it('should modify the signal', () => {
                                    return renderer({
                        ...
                        // Bug #185: Chrome adds an extra sample to the delay.
                        describe(
                            'with another AudioNode connected to the AudioParam',
                            { skip: typeof window === 'undefined' || /Chrome/.test(navigator.userAgent) },
                            () => {
                                it('should modify the signal', () => {
                                    return renderer({
        ...
        describe('connect()', () => {
            describe.for(['AudioNode', 'AudioParam'])('with an %s', (type) => {
                ...
                it('should throw an IndexSizeError if the output is out-of-bound', () => {
                    expect(() => delayNode.connect(audioNodeOrAudioParam, -1))
                        .to.throw(DOMException)
                ...
                if (type === 'AudioNode') {
                    it('should throw an IndexSizeError if the input is out-of-bound', () => {
                        expect(() => delayNode.connect(audioNodeOrAudioParam, 0, -1))
                            .to.throw(DOMException)
                            .to.include({ code: 1, name: 'IndexSizeError' });
                    });
            ...
            describe.for(['AudioNode', 'AudioParam'])('with an %s of another context', (type) => {
                ...
                it('should throw an InvalidAccessError', () => {
                    expect(() => delayNode.connect(audioNodeOrAudioParam))
                        .to.throw(DOMException)
            ...
            describe.for(['AudioNode', 'AudioParam'])('with an %s of a native context', (type) => {
                ...
                it('should throw an InvalidAccessError', () => {
                    expect(() => delayNode.connect(nativeAudioNodeOrAudioParam))
                        .to.throw(DOMException)
                        .to.include({ code: 15, name: 'InvalidAccessError' });
                });
            });
            ...
            describe('with a cycle', () => {
                ...
                it('should render a delayed signal', () => {
                    return renderer({
        ...
        describe('disconnect()', () => {
            ...
            describe('with a destination', () => {
                describe('without a connection to the given destination', () => {
                    ...
                    it('should throw an InvalidAccessError', () => {
                        expect(() => delayNode.disconnect(new GainNode(context)))
                            .to.throw(DOMException)
                            .to.include({ code: 15, name: 'InvalidAccessError' });
                    });
                });
            ...
            describe('with a destination and an output', () => {
                ...
                it('should throw an IndexSizeError if the output is out-of-bound', () => {
                    expect(() => delayNode.disconnect(new GainNode(context), -1))
                        .to.throw(DOMException)
                        .to.include({ code: 1, name: 'IndexSizeError' });
                });

                it('should throw an InvalidAccessError if there is no similar connection', () => {
                    expect(() => delayNode.disconnect(new GainNode(context), 0))
                        .to.throw(DOMException)
                        .to.include({ code: 15, name: 'InvalidAccessError' });
                });
            });
            ...
            describe('with a destination, an output and an input', () => {
                ...
                it('should throw an IndexSizeError if the output is out-of-bound', () => {
                    expect(() => delayNode.disconnect(new GainNode(context), -1, 0))
                        .to.throw(DOMException)
                        .to.include({ code: 1, name: 'IndexSizeError' });
                });

                it('should throw an IndexSizeError if the input is out-of-bound', () => {
                    expect(() => delayNode.disconnect(new GainNode(context), 0, -1))
                        .to.throw(DOMException)
                        .to.include({ code: 1, name: 'IndexSizeError' });
                });

                it('should throw an InvalidAccessError if there is no similar connection', () => {
                    expect(() => delayNode.disconnect(new GainNode(context), 0, 0))
                        .to.throw(DOMException)
                        .to.include({ code: 15, name: 'InvalidAccessError' });
                });
            });
